...
double pi=3.1415926,frequency=1.6,Y_amplitude=0.075,w_amplitude=1.2217304763960306,U_flow=3.0; /*the frequency is physical frequency, Y_amplitude is heaving amplitude, w_amplitude is pitching amplitude, U_flow is flow velocity*/
